...
<div class="container-fluid px-4 py-4">
  <div class="d-flex justify-content-between align-items-center mb-3">
    <h2 class="fw-semibold mb-0">Clinic Appointments</h2>
    <div class="d-flex">
      <input class="me-2" type="search" name="search" id="search-field" placeholder="Search">
      <select id="status-filter" class="form-select w-auto me-2">
...
<script>
  (function() {
    ...
    $('#generate-report').on('click', function() {
      ...
      window.open(`/healthsync/api/appointment/generate-report.php?type=clinic&${strReport}`, '_blank');
    })
