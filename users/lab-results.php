...
$appointments = $appointmentModel->findByUser($userId, status: 'COMPLETED', type: "labtech");
...
<body>
  <div class="container pt-4 pb-5">
    ...
    <h1 class="mb-4 text-center fw-bold text-primary">Lab Results</h1>

    <div id="appointments-container" class="row g-4">
      <?php if (empty(array_filter($appointments, fn($e) => $e['status'] === 'CANCELLED' || $e['status'] === 'COMPLETED'))) : ?>
