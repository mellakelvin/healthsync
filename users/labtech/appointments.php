...
<div class="container-fluid px-4 py-4">
  <div class="d-flex justify-content-between align-items-center mb-3">
    <h2 class="fw-semibold mb-0">Laboratory Appointments</h2>
    <div class="d-flex">
    ...
    <div class="modal-content rounded-4 shadow-sm">
      ...
      <div class="modal-body">
        ...
        <div id="file-upload-group" class="mt-3 d-none">
          <label for="lab-result-file" class="form-label">Attach Lab Result File</label>
...
<script>
  (function() {
    ...
    $('#generate-report').on('click', function() {
      ...
      window.open(`/healthsync/api/appointment/generate-report.php?type=labtech&${strReport}`, '_blank');
    })
